...
largura_tab = frame.shape[1]
largura_coluna = int(largura_tab/7)
...
pos = [[pos00, pos01, pos02, pos03, pos04, pos05, pos06],
...
for i in range(0,6):
    for j in range(0,7):
        ...
        # 1 -> peça vermelha
        # 2 -> peça amarela
        mat_jogo[i][j] = biblioteca.encontra_peca(pos[i][j])

print(mat_jogo)
ganhou = biblioteca.checa_vitoria(mat_jogo, 1)
